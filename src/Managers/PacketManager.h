...
#define XUO_SAVE_ALL_PACKETS 1
#define XUO_SAVE_PACKET 1

#if XUO_SAVE_ALL_PACKETS == 1
#define XUO_IGNORE_PACKET 1
#else
#define XUO_IGNORE_PACKET 0
#endif
