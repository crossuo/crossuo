...
// SPDX-FileCopyrightText: 2019 CrossUO Team
...
enum ANIMATION_GROUPS_TYPE : uint8_t
{
    AGT_MONSTER = 0,
    AGT_SEA_MONSTER,
    AGT_ANIMAL,
...
static_assert(int(PAG_ANIMATION_COUNT) > int(HAG_ANIMATION_COUNT), "bump max groups");
static_assert(int(PAG_ANIMATION_COUNT) > int(LAG_ANIMATION_COUNT), "bump max groups");
...
enum : int32_t
{
    ...
    MAX_MAPS_COUNT = 6,
    MAX_ANIMATION_GROUPS_COUNT = PAG_ANIMATION_COUNT,
    MAX_LAND_DATA_INDEX_COUNT = 0x4000,
    // >=CV_7090: count=0x10000, >=CV_7000: count=0x8000, <CV_7000: count=0x4000
    MAX_STATIC_DATA_INDEX_COUNT = 0x10000,
    MAX_LAND_TEXTURES_DATA_INDEX_COUNT = 0x4000,
    MAX_GUMP_DATA_INDEX_COUNT = 0x10000,
